...
Unlike other implementations, pyllrp generates the interfaces from the LLRP XML spec itself.  It is 100% compliant with the LLRP spec and Impinj extensions.
